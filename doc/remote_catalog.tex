...
\texttt{GR\_MALERT} & 420 & str title, str message $\rightarrow$ nothing, on dismissal; wid 0 \\
...
\texttt{GR\_MWRWAVE} & 8250 & i64 p, blk; the sender chunks to the channel bound \\
...
\texttt{GR\_MRDWAVE} & 8259 & i64 p, len $\rightarrow$ i64 n, blk; the caller chunks to the bound \\
