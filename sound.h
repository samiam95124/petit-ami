...
#define PA_INST_PAD_6_METALLIC        94;noteon(
...
void instchange(int p, t, channel c, instrument i);
...
void volsynthchan(int p, t, channel c, int v);
...
void tremulo(int p, t, channel c, int tr);
