...
#	gcc -g -o test stdio.c services.c xterm.c test.c -lm 
	
scntst: xterm.c terminal.h scntst.c stdio.c stdio.h services.h services.c Makefile
	gcc -g -o scntst stdio.c xterm.c services.c scntst.c -lm 
	
event: xterm.c terminal.h event.c stdio.c stdio.h Makefile
	gcc -g -o event stdio.c xterm.c event.c -lm 
