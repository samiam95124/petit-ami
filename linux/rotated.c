...
/*
 * Minor adaptions from the original at:
 *
 * https://root.cern/doc/v616/Rotated_8cxx_source.html
 *
 * Scott A. Franco 2022/05/18.
 *
 */
...
/* Changed to standard lib [saf] */
#include <math.h>
//#include "TMath.h"

/* Added no-op define [saf] */
#define int(a) (a)
                                  ...
                                  int align, int bg)
{
   ...
   sin_angle=/*TMath::S*/sin(angle);
   cos_angle=/*TMath::C*/cos(angle);
...
XPoint *XRotTextExtents(Display *display, XFontStruct *font, float angle, int x, int y, char *text,int align)
{
   int i;
   char *str1, *str2, *str3;
   const char *str2_a="\0", *str2_b="\n\0";
