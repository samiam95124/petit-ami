...
void tabbarsiz(FILE* f, strptr sp, tabori tor, long cw, long ch, long* w, long* h, long* ox, long* oy);
void tabbarsiz(strptr sp, tabori tor, long cw, long ch, long* w, long* h, long* ox, long* oy);
void tabbarsizg(FILE* f, strptr sp, tabori tor, long cw, long ch, long* w, long* h, long* ox, long* oy);
void tabbarsizg(strptr sp, tabori tor, long cw, long ch, long* w, long* h, long* ox, long* oy);
